...
## III. The Decentralized Exchange
...
**Automated Market Maker** (AMM), is a type of decentralized exchange that relies on algorithm to price assets and facilitate trades, living directly on the blockchain as smart contracts as an accessible, efficient and easy to bootstrap solution, making up the overwhelming majority of DEXs on Ethereum.
